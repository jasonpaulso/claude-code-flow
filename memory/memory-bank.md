...
_Created by **rUv** - [github.com/ruvnet/](https://github.com/ruvnet/)_
  ...
  "branchingPatterns": {
    "successful": {
      "feature-branches": {
        ...
        "examples": [
          "feature/architecture-audio-processor",
          "feature/refinement-encryption-layer"
        ],
...
const sessionToken = memoryBank.createSession(
  "claude-tdd-001",
  "ultrasonic-project",
);
...
const lockToken = memoryBank.requestResourceLock(
  "claude-tdd-001",
  "src/user-service.ts",
);
