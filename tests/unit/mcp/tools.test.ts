...
describe("ToolRegistry", () => {
  ...
  describe("Tool Registration", () => {
    ...
    it("should validate tool name format", () => {
      ...
      try {
        ...
        assertEquals(
          (error as Error).message.includes("format: namespace/name"),
          true,
        );
      }
    });
  ...
  describe("Tool Execution", () => {
    ...
    it("should execute a tool successfully", async () => {
      const result = await registry.executeTool("test/echo", {
        message: "Hello, World!",
      });
    ...
    it("should validate input against schema", async () => {
      try {
        ...
        assertEquals(
          (error as Error).message.includes("Missing required property"),
          true,
        );
      }
    });
