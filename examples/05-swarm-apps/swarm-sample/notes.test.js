...
describe("Notes CLI Test Suite", () => {
  ...
  describe("Note Search", () => {
    before(() => {
      manager.notes = [];
      manager.addNote("JavaScript Tutorial", "Learn JS basics", [
        "programming",
        "tutorial",
      ]);
      manager.addNote("Python Guide", "Python programming guide", [
        "programming",
        "python",
      ]);
      manager.addNote("Meeting Notes", "Discuss project timeline", [
        "work",
        "meeting",
      ]);
    });
