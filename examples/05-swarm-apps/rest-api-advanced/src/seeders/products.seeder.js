  ...
  // Electronics
  {
    ...
    products: [
      ...
      },
      {
        ...
        description:
          "Advanced fitness tracking smart watch with heart rate monitor, GPS, and smartphone integration.",
        price: 299.99,
        comparePrice: 399.99,
        brand: "TechCorp",
    ...
    products: [
      {
        ...
        description:
          "Comfortable 100% organic cotton t-shirt with modern fit and sustainable production.",
        price: 24.99,
        comparePrice: 34.99,
        brand: "FashionHub",
      ...
      },
      {
        ...
        description:
          "Classic straight-fit denim jeans with stretch comfort and timeless style.",
        price: 59.99,
        brand: "FashionHub",
    ...
    products: [
      {
        ...
        description:
          "WiFi-enabled RGB LED bulbs with app control and voice assistant compatibility.",
        price: 39.99,
        comparePrice: 59.99,
        brand: "HomeStyle",
    ...
    products: [
      {
        ...
        description:
          "Comprehensive guide to modern JavaScript programming with practical examples and best practices.",
        price: 39.99,
        brand: "BookWorld",
      ...
      },
      {
        ...
        description:
          "Master chef's guide to culinary excellence with over 200 recipes and techniques.",
        price: 29.99,
        comparePrice: 45.0,
        brand: "BookWorld",
    ...
    products: [
      {
        ...
        description:
          "Extra thick non-slip yoga mat with alignment marks and carrying strap.",
        price: 34.99,
        brand: "SportsPro",
      ...
      },
      {
        ...
        description:
          "Waterproof family camping tent with easy setup and excellent ventilation.",
        price: 129.99,
        comparePrice: 179.99,
        brand: "SportsPro",
...
async function seedProducts() {
  try {
    ...
    await mongoose.connect(
      process.env.MONGODB_URI || "mongodb://localhost:27017/rest-api-advanced",
    );
